...
public class DrawBridgeBlockStatesProvider extends CommonBlockStatesProvider {
	...
	protected void registerStatesAndModels() {
		...
		for (DrawBridgeBlock renderBlocks : ImmutableList.of(DRAW_BRIDGE_SOLID.get(), DRAW_BRIDGE_CUTOUT.get(), DRAW_BRIDGE_CUTOUT_MIPPED.get(), DRAW_BRIDGE_TRANSLUCTENT.get(), DRAW_BRIDGE_TRIPWIRE.get())) {
