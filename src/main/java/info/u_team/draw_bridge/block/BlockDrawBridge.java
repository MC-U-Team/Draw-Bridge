...
public class BlockDrawBridge extends UBlockTileEntity {
	...
	public static final TileEntityType<TileEntityDrawBridge> TILE_TYPE_DRAWBRIDGE = TileEntityType
			.register("drawbridge", TileEntityType.Builder.create(TileEntityDrawBridge::new));

	public BlockDrawBridge(String name) {
		super(name, Properties.create(Material.IRON).hardnessAndResistance(1.5f),
				new Item.Properties().group(DrawBridgeCreativeTabs.tab), TILE_TYPE_DRAWBRIDGE);
	...
	public IBlockState getStateForPlacement(BlockItemUseContext context) {
		return this.getStateForPlacement(null, context.getFace(), null, null, null, null, null);
	}
	...
	public IBlockState getStateForPlacement(IBlockState state, EnumFacing facing, IBlockState state2, IWorld world,
		...
		return getDefaultState().with(FACING, facing).with(ACTIVE, false);
	}
